      ...
      body: NotificationListener<OverscrollIndicatorNotification>(
        ...
        child: ListView(
          children: [
            ...
            message('Khusus Info 2D-TI', 'Adelina: Selamat malam teman2, maaf kemarin rabu', 'kemarin', Icons.done, Colors.grey, NetworkImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0_npgzbcjH_BvhqLeniK1kz2WOwNtjtAgcs8XQuu31qdInRQl948vXZUw8m2ntoEGrgA&usqp=CAU')),
            message('Maritta Dwi', 'Okey fir', '10.19', Icons.done_all, Colors.blue, NetworkImage('https://assets.promediateknologi.com/crop/0x0:0x0/x/photo/2021/08/31/3237294347.jpg')),
            message('Maritta Dwi', 'Okey fir', '10.19', Icons.done_all, Colors.blue, NetworkImage('https://assets.promediateknologi.com/crop/0x0:0x0/x/photo/2021/08/31/3237294347.jpg')),
            message('Maritta Dwi', 'Okey fir', '10.19', Icons.done_all, Colors.blue, NetworkImage('https://assets.promediateknologi.com/crop/0x0:0x0/x/photo/2021/08/31/3237294347.jpg')),
          ],
